package com.palyrobotics.frc2022.vision;
...
public class Limelight {
	...
	public final double kSpinCompensation = 0.0;
...
//		return true;
	...
	public double getYawToTarget() {
		return mTable.getEntry("tx").getDouble(0.0) + kSpinCompensation;
...
//		return _distance;
		// Tuned 2/15/22 using new 3d print (25 degrees or so)
		double oneTimesZoomAngle = 52.04;
