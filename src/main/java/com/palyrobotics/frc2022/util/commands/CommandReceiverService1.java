package com.palyrobotics.frc2022.util.commands;
...
public class CommandReceiverService1 implements RobotService {
	...
	public CommandReceiverService1() {
...
//                return String.format("Running with hood state %s and velocity %f", hoodState, manualSpeed);
				return String.format("Running with hood state %s and velocity %f", 0.0, 0.0);
			}
			default: {
