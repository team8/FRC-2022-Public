...
public class TimedSolenoid extends Solenoid {
	 ...
	 *                                 extend.
	 * @param isExtendedByDefault      Whether the default solenoid state (off) causes the piston to
	 *                                 extend. This is the extension state when the robot is disabled.
	 */
	public TimedSolenoid(PneumaticsModuleType moduleType, int channel, double extensionDurationSeconds, boolean isExtendedByDefault) {
