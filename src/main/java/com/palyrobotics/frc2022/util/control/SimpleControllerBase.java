...
public abstract class SimpleControllerBase<TController extends Controller> {
	...
	private static final Map<ControllerOutput.Mode, Integer> sModeToSlot = Map.of(
	...
	private final Map<Integer, Gains> mLastGains = new HashMap<>();
...
//		Robot.mDebugger.addPoint("getControlMode");
		...
		boolean requiresGains = isProfiled || mode == ControllerOutput.Mode.POSITION || mode == ControllerOutput.Mode.VELOCITY;
