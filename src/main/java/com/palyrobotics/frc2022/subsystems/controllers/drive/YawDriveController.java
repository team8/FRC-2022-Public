...
public class YawDriveController extends Drive.DriveController {
	...
	private ProfiledPIDController mController = new ProfiledPIDController(
			0.0, 0.0, 0.0, new TrapezoidProfile.Constraints(0.0, 0.0), Robot.kPeriod);
